...
required_any_terms=list(req.get('required_any_terms') or [])
if any(t not in terms for t in required_any_terms):
    raise RuntimeError('required_any_terms must be a subset of terms')
required_any=set(required_any_terms)
