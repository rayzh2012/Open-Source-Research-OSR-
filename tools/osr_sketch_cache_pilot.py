...
DEFAULT_QUERIES=[
    ...
    '元子','颛顼崩','帝喾立',
    # Ghost Discovery Pack v1: ontology + named ghosts + anti-ghost actors + variants.
    '鬼','恶鬼','惡鬼','厉鬼','厲鬼','疫鬼','疟鬼','瘧鬼','病鬼','疾病鬼','伥鬼','倀鬼','水鬼','溺鬼',
    '河鬼','江鬼','井鬼','船鬼','饿鬼','餓鬼','尸鬼','屍鬼','小鬼','老鬼','孤魂','野鬼','冤鬼','怨鬼',
    '虚耗','虛耗','鬼母','鬼姑','黄父鬼','黃父鬼','黄父','黃父','尺郭','赤郭','天郭','食邪',
    '中魁','钟馗','鍾馗','终葵','終葵','钟葵','鍾葵','神荼','郁垒','鬱壘','方相氏','傩','儺',
    '魑魅魍魉','魑魅魍魎','野仲','游光','鬾蜮','毕方','畢方','魌头','魌頭','渐耳','漸耳'
]
